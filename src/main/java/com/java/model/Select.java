...
//下面是对应礼品在库情况
    ...
    private String product_store_NO;
    private String product_store_Count_Input;
    private String product_store_Count_Select;
    private String product_store_select_ClassNO;


    private String product_store_select_menberNO;
    private String product_store_select_date;
	...
	public Select(String authName, String authPath, String authDescription,
                  String iconCls) {
		super();
    ...
    public Select(String menberName, String menberPath, String authDescription,
    ...
    public String getProduct_store_Count_Input() {
        return product_store_Count_Input;
    }

    public void setProduct_store_Count_Input(String product_store_Count_Input) {
        this.product_store_Count_Input = product_store_Count_Input;
    }

    public String getProduct_store_Count_Select() {
        return product_store_Count_Select;
    }

    public void setProduct_store_Count_Select(String product_store_Count_Select) {
        this.product_store_Count_Select = product_store_Count_Select;
    }

    public String getProduct_store_select_ClassNO() {
        return product_store_select_ClassNO;
    }

    public void setProduct_store_select_ClassNO(String product_store_select_ClassNO) {
        this.product_store_select_ClassNO = product_store_select_ClassNO;
    }

    public String getProduct_store_select_menberNO() {
        return product_store_select_menberNO;
    }

    public void setProduct_store_select_menberNO(String product_store_select_menberNO) {
        this.product_store_select_menberNO = product_store_select_menberNO;
    }

    public String getProduct_store_select_date() {
        return product_store_select_date;
    }

    public void setProduct_store_select_date(String product_store_select_date) {
        this.product_store_select_date = product_store_select_date;
    }
    ...
    public String getProduct_store_NO() {
        return product_store_NO;
    }

    public void setProduct_store_NO(String product_store_NO) {
        this.product_store_NO = product_store_NO;
    }
}
