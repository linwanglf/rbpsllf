...
public class CityDao {
	...
	public ResultSet cityList(Connection con, PageBean pageBean, City city)throws Exception{
		StringBuffer sb=new StringBuffer("select * from city");
		if(StringUtil.isNotEmpty(city.getProvincecode())){
			sb.append(" and provincecode = '" + city.getProvincecode()+ "'"  );
		}
		if(pageBean!=null){
