 ...
 */
@Slf4j
public class TestDynamicChartServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        log.info( DateUtil.getCurrent()  + " Start TestDynamicChartServlet ");
...
//        System.out.println("jsonArray: " + jsonArray);
        ...
        */
        ...
        log.info( DateUtil.getCurrent()  + " Finish TestDynamicChartServlet ");
    }
