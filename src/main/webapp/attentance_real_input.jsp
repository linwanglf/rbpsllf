...
<head>
    ...
    <script type="text/javascript">
        ...
        function openatt_realAddDialog(){
            $("#dlg").dialog("open").dialog("setTitle","添加加班实绩");
            url="attentance?action=saveatt_real";
        }
        ...
        function openatt_realModifyDialog(){
            ...
            url="attentance?action=saveatt_real&attId="+row.attId;
        }

        function saveatt_real(){
            var selectname;
        ...
        function closeatt_realAddDialog(){
            $("#dlg").dialog("close");
            $("#fm").form('clear');
        }
        ...
        function deleteatt_real(){
            ...
            $.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
                if(r){
                    //alert("当前值选择: " + ids);
                    $.post("attentance?action=deleteatt_real",{delIds:ids},function(result){
                        if(result.success){
...
<table id="dg" title="加班实绩录入" class="easyui-datagrid" fitColumns="true"
       pagination="true" rownumbers="true"  url="attentance?action=attentance_realList&s_parentId=-1" fit="true" toolbar="#tb">
    <thead>
    <tr>
...
<div id="tb">
    <div>
        <a href="javascript:openatt_realAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
        <a href="javascript:openatt_realModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
        <a href="javascript:deleteatt_real()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
    </div>
    <div>
    ...
    <form id="fm" method="post">
        <table cellspacing="7px;">
            ...
            <tr>
                <td>加班日期一：</td>
                <td colspan="1">
                    <input type="text"  style="width:150px;" name="applydate_first" class="easyui-datebox" required="required">
                </td>
                <td>计划时长：</td>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>计划时长：</td>
                <td colspan="1">
                    <input type="text" id="houre_second" name="houre_second"   onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" placeholder="1-16之间数字"  maxlength="2" minlength="1"/></td>
            ...
            <tr>
                ...
                <td>计划时长：</td>
                <td colspan="1">
                    <input type="text" id="houre_third" name="houre_third" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" placeholder="1-16之间数字"  maxlength="2" minlength="1"/></td>
            ...
            <tr>
                ...
                <td>计划时长：</td>
                <td colspan="1">
                    <input type="text" id="houre_fourth" name="houre_fourth"   onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" placeholder="1-16之间数字"  maxlength="2" minlength="1"/></td>
...
<div id="dlg-buttons">
    <a href="javascript:saveatt_real()" class="easyui-linkbutton" iconCls="icon-ok" >保存</a>
    <a href="javascript:closeatt_realAddDialog()" class="easyui-linkbutton" iconCls="icon-cancel" >关闭</a>
</div>
