			...
			collapse: function() {
				...
				a("." + i).each(function() {
					...
					i.each(function() {
						...
						t.find(".layui-colla-icon").remove(), t.append('<i class="layui-icon layui-colla-icon">' + (e ? "&#xe602;" : "&#xe61a;") + "</i>")
					})
				})
				a('.layui-collapse').off("click", '.layui-colla-title', f.collapse).on("click", '.layui-colla-title', f.collapse)
			}
		};
