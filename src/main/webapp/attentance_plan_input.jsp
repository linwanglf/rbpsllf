    ...
    <script type="text/javascript">
        ...
        function deleteatt_plan(){
            ...
            $.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
                if(r){
                    //alert("当前值选择: " + ids);
                    $.post("attentance?action=deleteatt_plan",{delIds:ids},function(result){
                        if(result.success){
...
<div id="tb">
    <div>
        <a href="javascript:openatt_planAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
        <a href="javascript:openatt_planModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
        <a href="javascript:deleteatt_plan()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
    </div>
    <div>
