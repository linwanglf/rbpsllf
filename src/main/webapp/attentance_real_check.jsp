...
//            url="attentance?action=saveatt_plan&attId="+row.attId;
        ...
        function checkatt_real(){
            ...
            $.messager.confirm("系统提示","您确认要同意审批这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
                if(r){
                    //alert("当前值选择: " + ids);
                    $.post("attentance?action=checkatt_real",{delIds:ids},function(result){
                        if(result.success){
        ...
        function cancelatt_real(){
            ...
            $.messager.confirm("系统提示","您确认要取消审批这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
                if(r){
                    //alert("当前值选择: " + ids);
                    $.post("attentance?action=cancelatt_real",{delIds:ids},function(result){
                        if(result.success){
...
<table id="dg" title="加班实绩确认" class="easyui-datagrid" fitColumns="true"
...
<div id="tb">
    <div>
        <a href="javascript:cancelatt_real()" class="easyui-linkbutton" iconCls="icon-no" plain="true">取消</a>
        <a href="javascript:checkatt_real()" class="easyui-linkbutton"  iconCls="icon-ok"  plain="true">审批</a>
    </div>
    <div>
