...
<table>
	<tr>
		...
		<td valign="bottom">欢迎：${currentUser.userName }&nbsp;『${currentUser.roleName }』;<%=session.getAttribute("currentUser")%></td>
	</tr>
</table>
</div>
</div>
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="MainPage" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px;"><font color="red" size="10">Welcome to E-factory </font></div>
		</div>
	</div>

</div>
<div region="west" style="width: 160px;padding: 5px;" title="navigate" split="true">
<ul id="tree" class="easyui-tree"></ul>
</div>
<div region="south" style="height: 25px;padding: 5px;" align="center">
    广汽传祺动力总成设备科 林尚芳<a href="http://www.gacmotor.com" target="_blank">www.gacmotor.com</a>
</div>
